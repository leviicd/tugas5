...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm bg-body-tertiary sticky-top">
      <div class="container">
        <a class="navbar-brand" href="#">PANDEM | ROCKET BUNNY</a>
        <button
    ...
    <section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
      <div class="container">
        <div class="d-sm-flex flex-sm-row-reverse align-items-center">
          <img src="img/bunny.jpg" class="img-fluid" width="300" />
          <div>
...
<section id="article" class="text-center p-5">
  <div class="container">
        ...
        <div id="carouselExample" class="carousel slide">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="https://static.wixstatic.com/media/c00c65_f95b4313ae5a4118a6ebe14c949fb1ab~mv2.png/v1/fill/w_1225,h_689,al_c,q_90,usm_0.66_1.00_0.01,enc_auto/c00c65_f95b4313ae5a4118a6ebe14c949fb1ab~mv2.png" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="https://static.wixstatic.com/media/c00c65_aab5332e582b45fba8b039e700bc1dae~mv2.png/v1/fill/w_1225,h_689,al_c,q_90,usm_0.66_1.00_0.01,enc_auto/c00c65_aab5332e582b45fba8b039e700bc1dae~mv2.png" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="https://static.wixstatic.com/media/c00c65_2cae1de0d074440e988e38436d9264a4~mv2.png/v1/fill/w_1225,h_689,al_c,q_90,usm_0.66_1.00_0.01,enc_auto/c00c65_2cae1de0d074440e988e38436d9264a4~mv2.png" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="https://static.wixstatic.com/media/c00c65_fe971e9d6b394b46b0279d6c9a2168c1~mv2.png/v1/fill/w_1225,h_689,al_c,q_90,usm_0.66_1.00_0.01,enc_auto/c00c65_fe971e9d6b394b46b0279d6c9a2168c1~mv2.png" class="d-block w-100" alt="..." />
            </div>
          </div>
          <button
    ...
    <section id="aboutme" class="text-center p-5 bg-danger-subtle">
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-center">
          <div class="p-3">
            <img
              src="https://vignette.wikia.nocookie.net/shingeki-no-kyojin/images/2/2d/Levi_Ackerman_(Anime).png/revision/latest?cb=20180816051528&path-prefix=es"
              class="rounded-circle border shadow"
              width="200"
            />
          </div>
          <div class="p-md-5 text-sm-start">
            <h3 class="lead">A11.2023.14949</h3>
            <h1 class="fw-bold">Pahlevi Cendikia Muslim</h1>
    ...
    <footer id="footer" class="text-center p-5">
      <div>
        <a href="https://www.instagram.com/leviicend/profilecard/?igsh=MTdzczYxNmQ2N3pxaw=="
          ><i class="bi bi-instagram h2 p-2"></i
        ></a>
        <a href="https://wa.me/+6281329123054"
          ><i class="bi bi-whatsapp h2 p-2"></i
        ></a>
      </div>
      <div>Pahlevi Cendikia Muslim &copy; 2024</div>
    </footer>
    <!-- footer end -->
